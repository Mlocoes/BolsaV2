...
def _get_async_database_url() -> str:
    """Construir ASYNC_DATABASE_URL desde env o secret"""
    # Si hay DATABASE_URL directo, usarlo pero cambiando driver
    db_url = _read_secret("DATABASE_URL")
    if db_url:
...
class Settings(BaseSettings):
    ...
    ASYNC_DATABASE_URL: str = _get_async_database_url() # type: ignore
