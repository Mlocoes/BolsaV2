      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-1">Archivo Excel o CSV *</label>
              <input
                type="file"
                accept=".xlsx, .xls, .csv"
          ...
          <div className="border-t pt-6">
            ...
            {activeTab === 'transactions' ? (
              <div className="bg-gray-50 p-4 rounded text-sm space-y-2">
                <p><strong>Formatos soportados:</strong> Excel (.xlsx, .xls) - Recomendado, CSV</p>
                <p><strong>Columnas requeridas:</strong> Data, C/V, Activo, Cantidad, Precio</p>
                <p><strong>Columnas opcionales:</strong> Fee, Nota</p>
                <p><strong>Valores de tipo:</strong> C (Compra), V (Venta)</p>
                <p><strong>Formato de fecha:</strong> DD/MM/YYYY</p>
                <p className="text-gray-600 italic">
                  Ejemplo: 01/01/2025,C,TSLA,100,400,0,Compra inicial
                </p>
              </div>
            ) : (
              <div className="bg-gray-50 p-4 rounded text-sm space-y-2">
